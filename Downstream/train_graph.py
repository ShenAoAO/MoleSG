...
if __name__ == '__main__':
    ...
    if args.split == 'scaffold':
        ...
        for idx in range(args.fold):
            ...
            best_valid_result, _ = model_train(model, train_dataset, valid_dataset, model_params, train_params, args.dataset, args.experiment_name,idx + 1)
